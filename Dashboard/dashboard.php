...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="View/assets/img/favicon.ico">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />

	<title>Dashboard FlooPets</title>
...
<div class="wrapper">
    <div class="sidebar" data-color="azure" data-image="View/assets/img/sidebar-5.jpg">
    ...
    -->
        ...
        <ul class="menu_dashboard">
            ...
            <li ><a href=""><i class="icono izquierda fa fa-star"></i> Gestionar Organizacion<i class="icono derecha fa fa-chevron-down"></i> </a>
                <ul>
                    <li><a href="">Registrar Organizacion</a></li>
                    <li><a href="">Actualizar Organizacion</a></li>
    ...
    <script src="View/assets/js/funciones_dashboard.js"></script>
