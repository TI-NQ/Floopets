...
// ASIGNAMOS UN LIMITE DE PESO A NUESTRO ARCHIVO ASIGNANDO UN VALOR EN Bytes
  if($_FILES["vo_imagen"]["size"][$i] > 7000000){
...
// VALIDAMOS SI $UPLOADOK ESTA EN 1 DE ESA FORMA SE PUEDE SUBIR
  ...
  if($uploadOk == 1){
      if (move_uploaded_file($_FILES["vo_imagen"]["tmp_name"][$i], $archivo)) {
          echo "El archivo ". basename( $_FILES["vo_imagen"]["name"][$i]). " se subio correctamente.  <br>";
      } else {
