	...
	switch ($accion) {
		case 'c':
				...
				$nombre_ani_imagen 	= strtolower(str_replace(' ', '', $nombre_ani_imagen));
		      	$ani_imagen   			= $nombre_ani_imagen."/".$_POST["ani_imagen"];
			...
			try {
				...
				Gestion_animal::Update($ani_cod_animal,$ra_cod_raza,$ani_nombre,$ani_color,$ani_tamanio,$ani_esterilizado,$ani_edad,$ani_descripcion,$ani_numero_microchip,$ani_sexo,$org_cod_organizacion,$ani_imagen);
