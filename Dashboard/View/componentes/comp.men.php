...
<li>
  ...
  <div class="collapsible-body"><p><a class="item_menu">Actualizar</a></p></div>
</li>
<li>
  <div class="collapsible-header grey lighten-2"><a><i class="fa fa-paw" aria-hidden="true"></i>Mis mascotas</a></div>
  <div class="collapsible-body"><p><a class="item_menu">Crear Nueva</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Ver mis Mascotas</a></p></div>
</li>
<li>
...
<li>
  ...
  <div class="collapsible-body"><p><a class="item_menu">Gestionar Eventos</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Historial de Eventos</a></p></div>
</li>
<li>
  <div class="collapsible-header grey lighten-2"><a><i class="fa fa-shield" aria-hidden="true"></i>Denuncias</a></div>
  <div class="collapsible-body"><p><a class="item_menu">Gestionar Denuncias</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Historial de Denuncias</a></p></div>
</li>
<!-- aqui metan el menu -->
<?php
...
<li>
  ...
  <div class="collapsible-body"><p><a class="item_menu">Nueva</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Historial</a></p></div>
</li>
<li>
  <div class="collapsible-header grey lighten-2"><a><i class="fa fa-calendar" aria-hidden="true"></i>Eventos</a></div>
  <div class="collapsible-body"><p><a class="item_menu">Nuevo</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Mis Eventos</a></p></div>
</li>
<li>
...
<li>
  ...
  <div class="collapsible-body"><p><a class="item_menu">Nueva</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Ver Todas</a></p></div>
</li>
<li>
  <div class="collapsible-header grey lighten-2"><a><i class="fa fa-plus" aria-hidden="true"></i>Voluntarios</a></div>
  <div class="collapsible-body"><p><a class="item_menu">Ver Voluntarios</a></p></div>
</li>
<li>
  <div class="collapsible-header grey lighten-2"><a><i class="fa fa-paw" aria-hidden="true"></i>Cuidados</a></div>
  <div class="collapsible-body"><p><a class="item_menu">Nuevo</a></p></div>
  <div class="collapsible-body"><p><a class="item_menu">Ver Todos</a></p></div>
</li>
      <!-- aqui metan el menu -->
<?php
}
