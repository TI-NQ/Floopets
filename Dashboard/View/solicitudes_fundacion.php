      ...
      <td>acciones </td>
		...
		<tbody>
           ...
           <td>".$row["usu_email"]."</td>
            ...
            <a class='btn-floating waves-light waves-effect' href='../Controller/animal.controller.php?us=".($row["usu_cod_usuario"])."&an=".($row["ani_cod_animal"])."&accion=aceptar'><i class='small material-icons'>done</i></a>
          </td>
