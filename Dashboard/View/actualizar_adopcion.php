...
<input type="hidden" readonly name="ani_cod_animal" required value="<?php echo $adopcion[4] ?>">
<input type="hidden" readonly name="usu_cod_usuario" required value="<?php echo $adopcion[5] ?>">
	<div class="form-group">
		<label class="form-label">fecha</label>
		<input class="form-control" type="date" name="ado_fecha" required  value="<?php echo $adopcion[1] ?>">
	</div>
	<div class="form-group">
...
<div class="file-field input-field col s12 m6">
                ...
                <div class="file-path-wrapper">
                  <input class="file-path validate"  type="text" placeholder="" name="ado_imagen" value="<?php echo $adopcion[3] ?>" >
                </div>
              </div>
	<div class="form-group">
